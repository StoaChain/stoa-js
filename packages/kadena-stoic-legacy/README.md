...
**`4.5.0` on public npmjs** — **MINOR (atomic-pair alignment with `@stoachain/stoa-core@4.5.0`).** Released 2026-09-15. NO code changes in this package; version bumped solely to hold the atomic-pair invariant. The 4.5.0 change — `KadenaWalletBuilder.createWalletPairFromDalosBitString` + the new `"stoic"` `SeedType` — lives entirely in `@stoachain/stoa-core`. Functionally identical to 4.4.0; consumers may pin to either interchangeably.

**`4.4.0` on public npmjs** — **MINOR (atomic-pair alignment with `@stoachain/stoa-core@4.4.0`).** Released 2026-09-07. NO code changes in this package; version bumped solely to hold the atomic-pair invariant. The 4.4.0 change — promoting the Yin Engine live gas-price floor formula into `@stoachain/stoa-core/gas` — lives entirely in `@stoachain/stoa-core`. Functionally identical to 4.3.7; consumers may pin to either interchangeably.

**`4.3.7` on public npmjs** — **PATCH (atomic-pair alignment with `@stoachain/stoa-core@4.3.7`).** Released 2026-07-22. NO code changes in this package; version bumped solely to hold the atomic-pair invariant. The 4.3.7 change — repointing the DALOS dependency to `@ouronet/dalos-crypto@4.0.4` — lives entirely in `@stoachain/stoa-core`. Functionally identical to 4.3.6; consumers may pin to either interchangeably.
...
**`4.3.5` on public npmjs** — **PATCH (atomic-triplet alignment with `@stoachain/stoa-core@4.3.5` + `@stoachain/ouronet-core@4.3.5`).** Released 2026-06-10. NO code changes in this package; version bumped solely to maintain the atomic-triplet invariant. The v4.3.5 surface (Smart Account deploy builder + keyset-ref-aware activation + T1 IGNIS-balance fix) lives entirely in `@stoachain/ouronet-core`. This package's CommonJS build is unaffected. Functionally identical to 4.3.4; consumers may pin to either interchangeably.

**`4.3.4` on public npmjs** — **PATCH (atomic-triplet alignment with `@stoachain/stoa-core@4.3.4` + `@stoachain/ouronet-core@4.3.4`).** Released 2026-06-08. NO code changes in this package; version bumped solely to maintain the atomic-triplet invariant. The v4.3.4 surface (the UrStoa Collect-button hover fix) lives entirely in `@stoachain/ouronet-core`. This package's CommonJS build is unaffected. Functionally identical to 4.3.3; consumers may pin to either interchangeably.

**`4.3.3` on public npmjs** — **PATCH (atomic-triplet alignment with `@stoachain/stoa-core@4.3.3` + `@stoachain/ouronet-core@4.3.3`).** Released 2026-05-30. NO code changes in this package; version bumped solely to maintain the atomic-triplet invariant (`tests/v4-1-1-cross-package-version-pin.test.ts`). The v4.3.3 surface lives entirely in `@stoachain/ouronet-core` (additive StoicTag + governor-rotation builders/readers). This package's CommonJS build is unaffected. Functionally identical to 4.3.1; consumers may pin to either interchangeably.

**`4.3.1` on public npmjs** — **PATCH (atomic-triplet alignment with `@stoachain/stoa-core@4.3.1` + `@stoachain/ouronet-core@4.3.1`).** Released 2026-05-27. NO code changes in this package; version bumped solely to maintain the atomic-triplet invariant (`tests/v4-1-1-cross-package-version-pin.test.ts`). The v4.3.1 surface lives entirely in stoa-core + ouronet-core (ESM extensionless-relative-import fix). This package's CommonJS build was never affected. Functionally identical to 4.3.0; consumers may pin to either interchangeably.

**`4.3.0` on public npmjs** — **MINOR (atomic-triplet with `@stoachain/stoa-core@4.3.0` + `@stoachain/ouronet-core@4.3.0`).** Released 2026-05-25. NO code changes in this package; version bumped solely to maintain the atomic-triplet invariant (`tests/v4-1-1-cross-package-version-pin.test.ts`) — the v4.3.0 surface lives entirely in `@stoachain/ouronet-core` (2 new account-rotation Pact builders supporting the new sibling package `@stoachain/ouronet-codex@0.1.0`'s headless rotation modals). Functionally identical to `4.2.2`; consumers may pin to either interchangeably.
...
**v4.5.0** — atomic-pair alignment bump. **MINOR (atomic with `@stoachain/stoa-core@4.5.0`).** Released 2026-09-15. NO code changes here; the 4.5.0 change (`createWalletPairFromDalosBitString` + the "stoic" `SeedType`) lives entirely in stoa-core. **55 specs pass.** Functionally identical to v4.4.0.

**v4.4.0** — atomic-pair alignment bump. **MINOR (atomic with `@stoachain/stoa-core@4.4.0`).** Released 2026-09-07. NO code changes here; the 4.4.0 change (promoting the Yin Engine live gas-price floor formula into `@stoachain/stoa-core/gas`) lives entirely in stoa-core. **55 specs pass.** Functionally identical to v4.3.7.

**v4.3.7** — atomic-pair alignment bump. **PATCH (atomic with `@stoachain/stoa-core@4.3.7`).** Released 2026-07-22. NO code changes here; the 4.3.7 change (repointing DALOS to `@ouronet/dalos-crypto@4.0.4`) lives entirely in stoa-core. **55 specs pass.** Functionally identical to v4.3.6.

**v4.3.6** — atomic-triplet alignment bump. **PATCH (atomic with `@stoachain/stoa-core@4.3.6` + `@stoachain/ouronet-core@4.3.6`).** Released 2026-06-11. NO code changes in this package; bumped solely to maintain the atomic-triplet invariant. The v4.3.6 change (a stoa-core auto-gas-limit floor fix) lives entirely in stoa-core. **55 specs pass.** Functionally identical to v4.3.5.

**v4.3.5** — atomic-triplet alignment bump. **PATCH (atomic with `@stoachain/stoa-core@4.3.5` + `@stoachain/ouronet-core@4.3.5`).** Released 2026-06-10. NO code changes in this package; bumped solely to maintain the atomic-triplet invariant. The v4.3.5 surface (Smart Account deploy builder + keyset-ref-aware activation + T1 IGNIS-balance fix) lives entirely in ouronet-core. **55 specs pass.** Functionally identical to v4.3.4.

**v4.3.4** — atomic-triplet alignment bump. **PATCH (atomic with `@stoachain/stoa-core@4.3.4` + `@stoachain/ouronet-core@4.3.4`).** Released 2026-06-08. NO code changes in this package; bumped solely to maintain the atomic-triplet invariant. The v4.3.4 surface (the UrStoa Collect-button hover fix) lives entirely in ouronet-core. **55 specs pass.** Functionally identical to v4.3.3.

**v4.3.3** — atomic-triplet alignment bump. **PATCH (atomic with `@stoachain/stoa-core@4.3.3` + `@stoachain/ouronet-core@4.3.3`).** Released 2026-05-30. NO code changes in this package; bumped solely to maintain the atomic-triplet invariant. The v4.3.3 surface lives entirely in ouronet-core (additive StoicTag + governor-rotation builders/readers). **55 specs pass.** Functionally identical to v4.3.0/v4.3.1.

**v4.3.1** — atomic-triplet alignment bump. **PATCH (atomic with `@stoachain/stoa-core@4.3.1` + `@stoachain/ouronet-core@4.3.1`).** Released 2026-05-27. NO code changes in this package; bumped solely to maintain the atomic-triplet invariant. The v4.3.1 surface lives entirely in stoa-core + ouronet-core (ESM extensionless-relative-import fix in their emitted dist). This package's CommonJS build was never affected by that bug. **55 specs pass.** Functionally identical to v4.3.0.

**v4.3.0** — atomic-triplet minor bump aligned with `@stoachain/ouronet-core@4.3.0`. **MINOR (atomic with `@stoachain/stoa-core@4.3.0` + `@stoachain/ouronet-core@4.3.0`).** Released 2026-05-25. NO code changes in this package; bumped solely to maintain the atomic-triplet invariant. The v4.3.0 release surface lives entirely in `@stoachain/ouronet-core` (2 new rotation Pact builders supporting the new sibling package `@stoachain/ouronet-codex@0.1.0`). **55 specs pass.** Functionally identical to v4.2.2.
